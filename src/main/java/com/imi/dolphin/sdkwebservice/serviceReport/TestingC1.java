...
public class TestingC1 {
    ...
    public ExtensionResult TestingC1_getReport(ExtensionRequest extensionRequest) {
        log.debug("TestingC1_getReport() extension request: {}", new Gson().toJson(extensionRequest, ExtensionRequest.class));
        ...
        String kodereport = appProp.getGARUDAFOOD_SHORTCUT_DAILYAUTOCLAIMS();
        ...
        String reportname = appProp.getGARUDAFOOD_REPORTCODE_DAILYAUTOCLAIMS();
        ...
        log.debug("TestingC1_getReport() extensionResult: {}", new Gson().toJson(extensionResult));
