 ...
 */
@Service
public class ServiceOTD1OFR1ByWeek_PeriodeShipment {
    ...
    public ExtensionResult otd1Ofr1ByWeek_PeriodeShipment_setFirstStatusCode(ExtensionRequest extensionRequest) {
        log.debug("otd1Ofr1ByWeek_PeriodeShipment_setFirstStatusCode() extension request: {}", new Gson().toJson(extensionRequest, ExtensionRequest.class));
    ...
    public ExtensionResult otd1Ofr1ByWeek_PeriodeShipment_KategoriGroupProduct(ExtensionRequest extensionRequest) {
        log.debug("otd1Ofr1ByWeek_PeriodeShipment_KategoriGroupProduct() extension request: {}", new Gson().toJson(extensionRequest, ExtensionRequest.class));
        ...
        switch (status_code) {
            case "0":
                String dialogsapa = "Baiklah, Bapak/Ibu " + fullName + " sudah berada di Report OTD1-OFR1 By Week(Periode Shipment).";
        ...
        extensionResult.setSuccess(true);
        extensionResult.setNext(true);
        log.debug("otd1Ofr1ByWeek_PeriodeShipment_KategoriGroupProduct() extensionResult: {}", new Gson().toJson(extensionResult));
        return extensionResult;
    }

    public ExtensionResult otd1Ofr1ByWeek_PeriodeShipment_tanyaSKU(ExtensionRequest extensionRequest) {
        log.debug("otd1Ofr1ByWeek_PeriodeShipment_tanyaSKU() extension request: {}", new Gson().toJson(extensionRequest, ExtensionRequest.class));
        Map<String, String> output = new HashMap<>();
        ExtensionResult extensionResult = new ExtensionResult();
        Map<String, String> clearEntities = new HashMap<>();
        StringBuilder sb = new StringBuilder();
        ...
        switch (status_code) {
            case "0":
                if (group.equalsIgnoreCase("next")) {
                    ...
                    dialog = "Silakan ketikan kode SKU yang Bapak/Ibu " + fullName + " inginkan. Atau ketik \"All\" untuk semua SKU berdasarkan Group Product.";
                    sb.append(dialog);
            ...
            case "1":
                ...
                if (sb.toString().equalsIgnoreCase("")) {
                    ...
                    String dialog2 = "Silakan ketikan kembali kode SKU yang Bapak/Ibu " + fullName + " inginkan. Atau ketik \"All\" untuk semua SKU berdasarkan Group.";
...
//                    clearEntities.put("sku", "");
        ...
        extensionResult.setSuccess(true);
        extensionResult.setNext(true);
        log.debug("otd1Ofr1ByWeek_PeriodeShipment_tanyaSKU() extensionResult: {}", new Gson().toJson(extensionResult));
        return extensionResult;
    }

    public ExtensionResult otd1Ofr1ByWeek_PeriodeShipment_Summary(ExtensionRequest extensionRequest) {
        log.debug("otd1Ofr1ByWeek_PeriodeShipment_Summary() extension request: {}", new Gson().toJson(extensionRequest, ExtensionRequest.class));
        Map<String, String> output = new HashMap<>();
        ExtensionResult extensionResult = new ExtensionResult();
        Map<String, String> clearEntities = new HashMap<>();
        ...
        extensionResult.setSuccess(true);
        extensionResult.setNext(true);
        log.debug("otd1Ofr1ByWeek_PeriodeShipment_Summary() extensionResult: {}", new Gson().toJson(extensionResult));
        return extensionResult;
    }

    public ExtensionResult otd1Ofr1ByWeek_PeriodeShipment_getReport(ExtensionRequest extensionRequest) {
        log.debug("otd1Ofr1ByWeek_PeriodeShipment_getReport() extension request: {}", new Gson().toJson(extensionRequest, ExtensionRequest.class));
        Map<String, String> output = new HashMap<>();
        ExtensionResult extensionResult = new ExtensionResult();
        Map<String, String> clearEntities = new HashMap<>();
        StringBuilder sb = new StringBuilder();
...
//        String fullName = "Deka Rizky";
        ...
        String kodereport = appProp.getGARUDAFOOD_SHORTCUT_otd1ofr1byweekshipment();
        ...
        String reportname = appProp.getGARUDAFOOD_REPORTCODE_otd1ofr1byweekshipment();
        ...
        extensionResult.setSuccess(true);
        extensionResult.setNext(true);
        log.debug("otd1Ofr1ByWeek_PeriodeShipment_getReport() extensionResult: {}", new Gson().toJson(extensionResult));
        return extensionResult;
    }

    public ExtensionResult otd1Ofr1ByWeek_PeriodeShipment_validasiReport(ExtensionRequest extensionRequest) {
        log.debug("otd1Ofr1ByWeek_PeriodeShipment_validasiReport() extension request: {}", new Gson().toJson(extensionRequest, ExtensionRequest.class));
        ExtensionResult extensionResult = new ExtensionResult();
        Map<String, String> clearEntities = new HashMap<>();
        ...
        extensionResult.setSuccess(true);
        extensionResult.setNext(true);
        log.debug("otd1Ofr1ByWeek_PeriodeShipment_validasiReport() extensionResult: {}", new Gson().toJson(extensionResult));
        return extensionResult;
    }
