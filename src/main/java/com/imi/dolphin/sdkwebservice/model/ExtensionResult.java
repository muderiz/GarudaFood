...
public class ExtensionResult implements Serializable {
    ...
    private String resultSendDocument;
    ...
    public String getResultSendDocument() {
        return resultSendDocument;
    }

    public void setResultSendDocument(String resultSendDocument) {
        this.resultSendDocument = resultSendDocument;
    }
